...
class MsgChatPedido extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'msgs_chats_pedidos';
    ...
    // Relación de msgs_chats_repartidores con ChatPedido:
	public function chat()
	{
		// 1 msg pertenece a un chat
		return $this->belongsTo('App\ChatPedido', 'chat_id');
	}
